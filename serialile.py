...
while cap.isOpened():
    ...
    if multiHandDetection:
        ...
        parmak_acikmi = 1 if myLP[1] > hs // 2 else 0
        ser.write(f"{servoX},{servoY},{parmak_acikmi}\n".encode())

        finger_status_text = "Parmak Kapalı" if parmak_acikmi else "Parmak Acik"
        cv2.putText(img, finger_status_text, (50, 150), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
